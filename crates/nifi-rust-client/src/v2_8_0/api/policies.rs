...
impl<'a> PoliciesApi<'a> {
    ...
    pub async fn create_access_policy(
        &self,
        body: &crate::v2_8_0::types::AccessPolicyEntity,
    ) -> Result<crate::v2_8_0::types::AccessPolicyEntity, NifiError> {
...
impl crate::v2_8_0::traits::PoliciesApi for PoliciesApi<'_> {
