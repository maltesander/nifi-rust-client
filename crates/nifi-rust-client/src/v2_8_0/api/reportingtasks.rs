...
impl crate::v2_8_0::traits::ReportingTasksApi for ReportingTasksApi<'_> {
    fn bulletins<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_8_0::traits::ReportingTasksBulletinsApi + 'b {
        ReportingTasksBulletinsApi {
            client: self.client,
            id,
        }
    ...
    fn config<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_8_0::traits::ReportingTasksConfigApi + 'b {
        ReportingTasksConfigApi {
            client: self.client,
            id,
        }
    ...
    fn descriptors<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_8_0::traits::ReportingTasksDescriptorsApi + 'b {
        ReportingTasksDescriptorsApi {
            client: self.client,
            id,
        }
    ...
    fn run_status<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_8_0::traits::ReportingTasksRunStatusApi + 'b {
        ReportingTasksRunStatusApi {
            client: self.client,
            id,
        }
    }
    fn state<'b>(&'b self, id: &'b str) -> impl crate::v2_8_0::traits::ReportingTasksStateApi + 'b {
        ReportingTasksStateApi {
            client: self.client,
            id,
        }
