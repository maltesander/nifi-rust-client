...
impl<'a> SiteToSiteApi<'a> {
    ...
    pub async fn get_site_to_site_details(
        ...
        let e: crate::v2_8_0::types::ControllerEntity = self.client.get("/site-to-site").await?;
        Ok(e.controller)
    }
    ...
    /// # Permissions
    /// Requires `Read - /site-to-site`.
    pub async fn get_peers(&self) -> Result<crate::v2_8_0::types::PeersEntity, NifiError> {
