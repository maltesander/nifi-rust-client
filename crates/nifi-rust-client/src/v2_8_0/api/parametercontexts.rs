...
impl crate::v2_8_0::traits::ParameterContextsApi for ParameterContextsApi<'_> {
    fn assets<'b>(
        &'b self,
        context_id: &'b str,
    ) -> impl crate::v2_8_0::traits::ParameterContextsAssetsApi + 'b {
        ParameterContextsAssetsApi {
            client: self.client,
            context_id,
        }
    ...
    fn update_requests<'b>(
        &'b self,
        context_id: &'b str,
    ) -> impl crate::v2_8_0::traits::ParameterContextsUpdateRequestsApi + 'b {
        ParameterContextsUpdateRequestsApi {
            client: self.client,
            context_id,
        }
    ...
    fn validation_requests<'b>(
        &'b self,
        context_id: &'b str,
    ) -> impl crate::v2_8_0::traits::ParameterContextsValidationRequestsApi + 'b {
        ParameterContextsValidationRequestsApi {
            client: self.client,
            context_id,
        }
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_8_0::traits::ParameterContextsAssetsApi for ParameterContextsAssetsApi<'_> {
    async fn get_assets(&self) -> Result<crate::v2_8_0::types::AssetsEntity, NifiError> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_8_0::traits::ParameterContextsUpdateRequestsApi
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_8_0::traits::ParameterContextsValidationRequestsApi
