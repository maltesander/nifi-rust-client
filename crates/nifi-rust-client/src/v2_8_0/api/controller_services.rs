...
impl crate::v2_8_0::traits::ControllerServicesApi for ControllerServicesApi<'_> {
    fn bulletins<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_8_0::traits::ControllerServicesBulletinsApi + 'b {
        ControllerServicesBulletinsApi {
            client: self.client,
            id,
        }
    ...
    fn config<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_8_0::traits::ControllerServicesConfigApi + 'b {
        ControllerServicesConfigApi {
            client: self.client,
            id,
        }
    ...
    fn descriptors<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_8_0::traits::ControllerServicesDescriptorsApi + 'b {
        ControllerServicesDescriptorsApi {
            client: self.client,
            id,
        }
    ...
    fn references<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_8_0::traits::ControllerServicesReferencesApi + 'b {
        ControllerServicesReferencesApi {
            client: self.client,
            id,
        }
    ...
    fn run_status<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_8_0::traits::ControllerServicesRunStatusApi + 'b {
        ControllerServicesRunStatusApi {
            client: self.client,
            id,
        }
    ...
    fn state<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_8_0::traits::ControllerServicesStateApi + 'b {
        ControllerServicesStateApi {
            client: self.client,
            id,
        }
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_8_0::traits::ControllerServicesBulletinsApi for ControllerServicesBulletinsApi<'_> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_8_0::traits::ControllerServicesConfigApi for ControllerServicesConfigApi<'_> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_8_0::traits::ControllerServicesDescriptorsApi
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_8_0::traits::ControllerServicesReferencesApi
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_8_0::traits::ControllerServicesRunStatusApi for ControllerServicesRunStatusApi<'_> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_8_0::traits::ControllerServicesStateApi for ControllerServicesStateApi<'_> {
