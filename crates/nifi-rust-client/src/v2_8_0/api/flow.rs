...
impl<'a> FlowApi<'a> {
    ...
    pub async fn get_flow_metrics(
        ...
        if let Some(v) = flow_metrics_reporting_strategy {
            query.push(("flowMetricsReportingStrategy", v.to_string()));
        }
        self.client
    ...
    ///
    /// - `id`: The process group id.
    pub fn bulletins<'b>(&'b self, id: &'b str) -> FlowBulletinsApi<'b> {
        FlowBulletinsApi {
            client: self.client,
            id,
        }
...
impl<'a> FlowBulletinsApi<'a> {
    ...
    pub async fn clear_bulletins_1(
        ...
        self.client
            .post(
                &format!("/flow/process-groups/{id}/bulletins/clear-requests"),
                body,
            )
            .await
    }
...
impl crate::v2_8_0::traits::FlowApi for FlowApi<'_> {
    fn branches<'b>(&'b self, id: &'b str) -> impl crate::v2_8_0::traits::FlowBranchesApi + 'b {
        FlowBranchesApi {
            client: self.client,
            id,
        }
    ...
    fn breadcrumbs<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_8_0::traits::FlowBreadcrumbsApi + 'b {
        FlowBreadcrumbsApi {
            client: self.client,
            id,
        }
    }
    fn buckets<'b>(&'b self, id: &'b str) -> impl crate::v2_8_0::traits::FlowBucketsApi + 'b {
        FlowBucketsApi {
            client: self.client,
            id,
        }
    }
    fn bulletins<'b>(&'b self, id: &'b str) -> impl crate::v2_8_0::traits::FlowBulletinsApi + 'b {
        FlowBulletinsApi {
            client: self.client,
            id,
        }
    ...
    fn controller_services<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_8_0::traits::FlowControllerServicesApi + 'b {
        FlowControllerServicesApi {
            client: self.client,
            id,
        }
    }
    fn statistics<'b>(&'b self, id: &'b str) -> impl crate::v2_8_0::traits::FlowStatisticsApi + 'b {
        FlowStatisticsApi {
            client: self.client,
            id,
        }
    }
    fn status<'b>(&'b self, id: &'b str) -> impl crate::v2_8_0::traits::FlowStatusApi + 'b {
        FlowStatusApi {
            client: self.client,
            id,
        }
    }
    async fn get_about_info(&self) -> Result<crate::v2_8_0::types::AboutDto, NifiError> {
    ...
    async fn get_banners(&self) -> Result<crate::v2_8_0::types::BannerDto, NifiError> {
    ...
    async fn get_current_user(&self) -> Result<crate::v2_8_0::types::CurrentUserEntity, NifiError> {
    ...
    async fn get_action(&self, id: &str) -> Result<crate::v2_8_0::types::ActionEntity, NifiError> {
        self.get_action(id).await
    }
    async fn get_listen_ports(&self) -> Result<crate::v2_8_0::types::ListenPortsEntity, NifiError> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_8_0::traits::FlowBranchesApi for FlowBranchesApi<'_> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_8_0::traits::FlowBreadcrumbsApi for FlowBreadcrumbsApi<'_> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_8_0::traits::FlowBucketsApi for FlowBucketsApi<'_> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_8_0::traits::FlowBulletinsApi for FlowBulletinsApi<'_> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_8_0::traits::FlowControllerServicesApi for FlowControllerServicesApi<'_> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_8_0::traits::FlowStatisticsApi for FlowStatisticsApi<'_> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_8_0::traits::FlowStatusApi for FlowStatusApi<'_> {
