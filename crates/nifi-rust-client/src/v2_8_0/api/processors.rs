...
impl crate::v2_8_0::traits::ProcessorsApi for ProcessorsApi<'_> {
    fn bulletins<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_8_0::traits::ProcessorsBulletinsApi + 'b {
        ProcessorsBulletinsApi {
            client: self.client,
            id,
        }
    }
    fn config<'b>(&'b self, id: &'b str) -> impl crate::v2_8_0::traits::ProcessorsConfigApi + 'b {
        ProcessorsConfigApi {
            client: self.client,
            id,
        }
    ...
    fn descriptors<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_8_0::traits::ProcessorsDescriptorsApi + 'b {
        ProcessorsDescriptorsApi {
            client: self.client,
            id,
        }
    ...
    fn diagnostics<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_8_0::traits::ProcessorsDiagnosticsApi + 'b {
        ProcessorsDiagnosticsApi {
            client: self.client,
            id,
        }
    ...
    fn run_status<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_8_0::traits::ProcessorsRunStatusApi + 'b {
        ProcessorsRunStatusApi {
            client: self.client,
            id,
        }
    }
    fn state<'b>(&'b self, id: &'b str) -> impl crate::v2_8_0::traits::ProcessorsStateApi + 'b {
        ProcessorsStateApi {
            client: self.client,
            id,
        }
    }
    fn threads<'b>(&'b self, id: &'b str) -> impl crate::v2_8_0::traits::ProcessorsThreadsApi + 'b {
        ProcessorsThreadsApi {
            client: self.client,
            id,
        }
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_8_0::traits::ProcessorsBulletinsApi for ProcessorsBulletinsApi<'_> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_8_0::traits::ProcessorsConfigApi for ProcessorsConfigApi<'_> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_8_0::traits::ProcessorsDescriptorsApi for ProcessorsDescriptorsApi<'_> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_8_0::traits::ProcessorsDiagnosticsApi for ProcessorsDiagnosticsApi<'_> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_8_0::traits::ProcessorsRunStatusApi for ProcessorsRunStatusApi<'_> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_8_0::traits::ProcessorsStateApi for ProcessorsStateApi<'_> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_8_0::traits::ProcessorsThreadsApi for ProcessorsThreadsApi<'_> {
