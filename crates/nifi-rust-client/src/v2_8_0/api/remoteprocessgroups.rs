...
impl crate::v2_8_0::traits::RemoteProcessGroupsApi for RemoteProcessGroupsApi<'_> {
    fn bulletins<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_8_0::traits::RemoteProcessGroupsBulletinsApi + 'b {
        RemoteProcessGroupsBulletinsApi {
            client: self.client,
            id,
        }
    ...
    fn input_ports<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_8_0::traits::RemoteProcessGroupsInputPortsApi + 'b {
        RemoteProcessGroupsInputPortsApi {
            client: self.client,
            id,
        }
    ...
    fn output_ports<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_8_0::traits::RemoteProcessGroupsOutputPortsApi + 'b {
        RemoteProcessGroupsOutputPortsApi {
            client: self.client,
            id,
        }
    ...
    fn run_status<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_8_0::traits::RemoteProcessGroupsRunStatusApi + 'b {
        RemoteProcessGroupsRunStatusApi {
            client: self.client,
            id,
        }
    ...
    fn state<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_8_0::traits::RemoteProcessGroupsStateApi + 'b {
        RemoteProcessGroupsStateApi {
            client: self.client,
            id,
        }
