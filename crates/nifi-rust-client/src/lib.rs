...
//! | `nifi-2-6-0`, `nifi-2-7-2`, `nifi-2-8-0`, `nifi-2-9-0`, `nifi-2-10-0`, `nifi-2-11-0`, `nifi-2-12-0` | Compile against a specific NiFi version. The semver-latest is the default. |
