...
impl crate::v2_7_2::traits::InputPortsApi for InputPortsApi<'_> {
    fn bulletins<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_7_2::traits::InputPortsBulletinsApi + 'b {
        InputPortsBulletinsApi {
            client: self.client,
            id,
        }
    ...
    fn run_status<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_7_2::traits::InputPortsRunStatusApi + 'b {
        InputPortsRunStatusApi {
            client: self.client,
            id,
        }
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_7_2::traits::InputPortsBulletinsApi for InputPortsBulletinsApi<'_> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_7_2::traits::InputPortsRunStatusApi for InputPortsRunStatusApi<'_> {
