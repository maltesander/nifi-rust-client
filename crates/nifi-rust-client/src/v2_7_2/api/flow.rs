...
impl<'a> FlowApi<'a> {
    ...
    /// # Permissions
    /// Requires `Read - /flow`.
    pub async fn get_about_info(&self) -> Result<crate::v2_7_2::types::AboutDto, NifiError> {
        let e: crate::v2_7_2::types::AboutEntity = self.client.get("/flow/about").await?;
    ...
    /// # Permissions
    /// Requires `Read - /flow`.
    pub async fn get_banners(&self) -> Result<crate::v2_7_2::types::BannerDto, NifiError> {
        let e: crate::v2_7_2::types::BannerEntity = self.client.get("/flow/banners").await?;
    ...
    pub async fn get_bulletin_board(
        ...
        let e: crate::v2_7_2::types::BulletinBoardEntity = self
            .client
    ...
    pub async fn get_cluster_summary(
        ...
        let e: crate::v2_7_2::types::ClusterSummaryEntity =
    ...
    pub async fn get_flow_config(
        ...
        let e: crate::v2_7_2::types::FlowConfigurationEntity =
    ...
    pub async fn get_current_user(
        &self,
    ) -> Result<crate::v2_7_2::types::CurrentUserEntity, NifiError> {
    ...
    pub async fn query_history(
        ...
        let e: crate::v2_7_2::types::HistoryEntity =
    ...
    pub async fn get_component_history(
        ...
        let e: crate::v2_7_2::types::ComponentHistoryEntity = self
            .client
    ...
    pub async fn get_action(
        &self,
        id: &str,
    ) -> Result<crate::v2_7_2::types::ActionEntity, NifiError> {
    ...
    pub async fn get_listen_ports(
        &self,
    ) -> Result<crate::v2_7_2::types::ListenPortsEntity, NifiError> {
    ...
    pub async fn get_runtime_manifest(
        ...
        let e: crate::v2_7_2::types::RuntimeManifestEntity =
    ...
    pub async fn search_flow(
        ...
        let e: crate::v2_7_2::types::SearchResultsEntity = self
            .client
    ...
    pub async fn get_controller_status(
        ...
        let e: crate::v2_7_2::types::ControllerStatusEntity =
...
impl<'a> FlowBucketsApi<'a> {
    ...
    pub async fn get_details(
        ...
        let e: crate::v2_7_2::types::VersionedFlowEntity = self
            .client
            .get_with_query(
                &format!(
