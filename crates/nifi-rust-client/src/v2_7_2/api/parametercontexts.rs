...
impl crate::v2_7_2::traits::ParameterContextsApi for ParameterContextsApi<'_> {
    fn assets<'b>(
        &'b self,
        context_id: &'b str,
    ) -> impl crate::v2_7_2::traits::ParameterContextsAssetsApi + 'b {
        ParameterContextsAssetsApi {
            client: self.client,
            context_id,
        }
    ...
    fn update_requests<'b>(
        &'b self,
        context_id: &'b str,
    ) -> impl crate::v2_7_2::traits::ParameterContextsUpdateRequestsApi + 'b {
        ParameterContextsUpdateRequestsApi {
            client: self.client,
            context_id,
        }
    ...
    fn validation_requests<'b>(
        &'b self,
        context_id: &'b str,
    ) -> impl crate::v2_7_2::traits::ParameterContextsValidationRequestsApi + 'b {
        ParameterContextsValidationRequestsApi {
            client: self.client,
            context_id,
        }
