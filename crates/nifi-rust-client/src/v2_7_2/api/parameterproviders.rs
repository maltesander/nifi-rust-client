...
impl<'a> ParameterProvidersApplyParametersRequestsApi<'a> {
    ...
    pub async fn submit_apply_parameters(
        ...
        let e: crate::v2_7_2::types::ParameterProviderApplyParametersRequestEntity = self
            .client
            .post(
...
impl<'a> ParameterProvidersStateApi<'a> {
    ...
    /// # Permissions
    /// Requires `Write - /parameter-providers/{uuid}`.
    pub async fn get_state_1(&self) -> Result<crate::v2_7_2::types::ComponentStateDto, NifiError> {
        let id = self.id;
...
impl crate::v2_7_2::traits::ParameterProvidersApi for ParameterProvidersApi<'_> {
    fn apply_parameters_requests<'b>(
        &'b self,
        provider_id: &'b str,
    ) -> impl crate::v2_7_2::traits::ParameterProvidersApplyParametersRequestsApi + 'b {
        ParameterProvidersApplyParametersRequestsApi {
            client: self.client,
            provider_id,
        }
    ...
    fn bulletins<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_7_2::traits::ParameterProvidersBulletinsApi + 'b {
        ParameterProvidersBulletinsApi {
            client: self.client,
            id,
        }
    ...
    fn config<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_7_2::traits::ParameterProvidersConfigApi + 'b {
        ParameterProvidersConfigApi {
            client: self.client,
            id,
        }
    ...
    fn descriptors<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_7_2::traits::ParameterProvidersDescriptorsApi + 'b {
        ParameterProvidersDescriptorsApi {
            client: self.client,
            id,
        }
    ...
    fn parameters<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_7_2::traits::ParameterProvidersParametersApi + 'b {
        ParameterProvidersParametersApi {
            client: self.client,
            id,
        }
    ...
    fn references<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_7_2::traits::ParameterProvidersReferencesApi + 'b {
        ParameterProvidersReferencesApi {
            client: self.client,
            id,
        }
    ...
    fn state<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_7_2::traits::ParameterProvidersStateApi + 'b {
        ParameterProvidersStateApi {
            client: self.client,
            id,
        }
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_7_2::traits::ParameterProvidersApplyParametersRequestsApi
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_7_2::traits::ParameterProvidersBulletinsApi for ParameterProvidersBulletinsApi<'_> {
    async fn clear_bulletins_4(
        &self,
        body: &crate::v2_7_2::types::ClearBulletinsRequestEntity,
    ) -> Result<crate::v2_7_2::types::ClearBulletinsResultEntity, NifiError> {
        self.clear_bulletins_4(body).await
    }
}
#[allow(clippy::too_many_arguments)]
impl crate::v2_7_2::traits::ParameterProvidersConfigApi for ParameterProvidersConfigApi<'_> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_7_2::traits::ParameterProvidersDescriptorsApi
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_7_2::traits::ParameterProvidersParametersApi
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_7_2::traits::ParameterProvidersReferencesApi
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_7_2::traits::ParameterProvidersStateApi for ParameterProvidersStateApi<'_> {
