...
impl<'a> TenantsApi<'a> {
    ...
    pub async fn get_user_groups(
        &self,
    ) -> Result<crate::v2_7_2::types::UserGroupsEntity, NifiError> {
    ...
    /// # Permissions
    /// Requires `Read - /tenants`.
    pub async fn get_users(&self) -> Result<crate::v2_7_2::types::UsersEntity, NifiError> {
    ...
    /// # Permissions
    /// Requires `Read - /tenants`.
    pub async fn get_user(&self, id: &str) -> Result<crate::v2_7_2::types::UserEntity, NifiError> {
...
impl crate::v2_7_2::traits::TenantsApi for TenantsApi<'_> {
