...
impl crate::v2_7_2::traits::ControllerServicesApi for ControllerServicesApi<'_> {
    fn bulletins<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_7_2::traits::ControllerServicesBulletinsApi + 'b {
        ControllerServicesBulletinsApi {
            client: self.client,
            id,
        }
    ...
    fn config<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_7_2::traits::ControllerServicesConfigApi + 'b {
        ControllerServicesConfigApi {
            client: self.client,
            id,
        }
    ...
    fn descriptors<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_7_2::traits::ControllerServicesDescriptorsApi + 'b {
        ControllerServicesDescriptorsApi {
            client: self.client,
            id,
        }
    ...
    fn references<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_7_2::traits::ControllerServicesReferencesApi + 'b {
        ControllerServicesReferencesApi {
            client: self.client,
            id,
        }
    ...
    fn run_status<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_7_2::traits::ControllerServicesRunStatusApi + 'b {
        ControllerServicesRunStatusApi {
            client: self.client,
            id,
        }
    ...
    fn state<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_7_2::traits::ControllerServicesStateApi + 'b {
        ControllerServicesStateApi {
            client: self.client,
            id,
        }
