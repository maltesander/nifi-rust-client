...
impl InputPortsApi for V2_8_0InputPortsApi<'_> {
    async fn clear_bulletins_2(
        ...
        Ok(api
            .clear_bulletins_2(&crate::v2_8_0::types::ClearBulletinsRequestEntity::try_from(body)?)
            .await?
            .into())
    }
    ...
    async fn update_run_status_2(
        ...
        Ok(api
            .update_run_status_2(&crate::v2_8_0::types::PortRunStatusEntity::try_from(body)?)
            .await?
            .into())
    }
}
