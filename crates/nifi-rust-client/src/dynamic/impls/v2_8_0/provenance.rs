...
pub(crate) struct V2_8_0ProvenanceApi<'a> {
    pub(crate) client: &'a crate::NifiClient,
}
#[allow(unused_variables)]
impl ProvenanceApi for V2_8_0ProvenanceApi<'_> {
    ...
    async fn submit_provenance_request(
        ...
        Ok(api
            .submit_provenance_request(&crate::v2_8_0::types::ProvenanceEntity::try_from(body)?)
            .await?
            .into())
    }
}
