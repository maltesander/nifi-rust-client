...
pub(crate) struct V2_8_0ParameterContextsApi<'a> {
...
impl ParameterContextsApi for V2_8_0ParameterContextsApi<'_> {
    ...
    async fn create_parameter_context(
        ...
        Ok(api
            .create_parameter_context(&crate::v2_8_0::types::ParameterContextEntity::try_from(
                body,
            )?)
            .await?
            .into())
    ...
    async fn delete_update_request(
        ...
        let api = crate::v2_8_0::api::parametercontexts::ParameterContextsUpdateRequestsApi {
            client: self.client,
            context_id,
        };
        Ok(api
    ...
    async fn delete_validation_request(
        ...
        let api = crate::v2_8_0::api::parametercontexts::ParameterContextsValidationRequestsApi {
            client: self.client,
            context_id,
        };
        Ok(api
    ...
    async fn submit_validation_request(
        ...
        Ok(api
            .submit_validation_request(
                &crate::v2_8_0::types::ParameterContextValidationRequestEntity::try_from(body)?,
            )
            .await?
            .into())
    }
