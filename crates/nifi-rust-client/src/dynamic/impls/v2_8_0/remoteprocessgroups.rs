...
impl RemoteProcessGroupsApi for V2_8_0RemoteProcessGroupsApi<'_> {
    async fn clear_bulletins_6(
        ...
        let api = crate::v2_8_0::api::remoteprocessgroups::RemoteProcessGroupsBulletinsApi {
            client: self.client,
            id,
        };
        Ok(api
            .clear_bulletins_6(&crate::v2_8_0::types::ClearBulletinsRequestEntity::try_from(body)?)
            .await?
            .into())
    }
    ...
    async fn update_remote_process_group_input_port(
        ...
        let api = crate::v2_8_0::api::remoteprocessgroups::RemoteProcessGroupsInputPortsApi {
            client: self.client,
            id,
        };
        Ok(api
    ...
    async fn update_remote_process_group_output_port(
        ...
        let api = crate::v2_8_0::api::remoteprocessgroups::RemoteProcessGroupsOutputPortsApi {
            client: self.client,
            id,
        };
        Ok(api
    ...
    async fn update_remote_process_group_run_status(
        ...
        let api = crate::v2_8_0::api::remoteprocessgroups::RemoteProcessGroupsRunStatusApi {
            client: self.client,
            id,
        };
        Ok(api
