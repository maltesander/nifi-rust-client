...
impl ControllerServicesApi for V2_6_0ControllerServicesApi<'_> {
    ...
    async fn get_controller_service_references(
        ...
        let api = crate::v2_6_0::api::controller_services::ControllerServicesReferencesApi {
            client: self.client,
            id,
        };
    ...
    async fn get_property_descriptor_1(
        ...
        let api = crate::v2_6_0::api::controller_services::ControllerServicesDescriptorsApi {
            client: self.client,
            id,
        };
        Ok(api
