...
pub(crate) struct V2_6_0VersionsApi<'a> {
    pub(crate) client: &'a crate::NifiClient,
}
#[allow(unused_variables)]
impl VersionsApi for V2_6_0VersionsApi<'_> {
    ...
    async fn initiate_revert_flow_version(
        ...
        Ok(api
            .initiate_revert_flow_version(
                id,
                &crate::v2_6_0::types::VersionControlInformationEntity::try_from(body.clone())?,
            )
            .await?
            .into())
    }
    ...
    async fn save_to_flow_registry(
        ...
        Ok(api
            .save_to_flow_registry(
                id,
                &crate::v2_6_0::types::StartVersionControlRequestEntity::try_from(body.clone())?,
            )
            .await?
            .into())
    }
