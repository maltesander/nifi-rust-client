...
pub(crate) struct V2_6_0ControllerApi<'a> {
    pub(crate) client: &'a crate::NifiClient,
}
#[allow(unused_variables)]
impl ControllerApi for V2_6_0ControllerApi<'_> {
    ...
    async fn create_controller_service(
        ...
        Ok(api
            .create_controller_service(&crate::v2_6_0::types::ControllerServiceEntity::try_from(
                body,
            )?)
            .await?
            .into())
    ...
    async fn create_flow_analysis_rule(
        ...
        Ok(api
            .create_flow_analysis_rule(&crate::v2_6_0::types::FlowAnalysisRuleEntity::try_from(
                body,
            )?)
            .await?
            .into())
    ...
    async fn create_flow_registry_client(
        ...
        Ok(api
            .create_flow_registry_client(&crate::v2_6_0::types::FlowRegistryClientEntity::try_from(
                body,
            )?)
            .await?
            .into())
    ...
    async fn create_parameter_provider(
        ...
        Ok(api
            .create_parameter_provider(&crate::v2_6_0::types::ParameterProviderEntity::try_from(
                body,
            )?)
            .await?
            .into())
    ...
    async fn create_reporting_task(
        ...
        Ok(api
            .create_reporting_task(&crate::v2_6_0::types::ReportingTaskEntity::try_from(body)?)
            .await?
            .into())
    }
    ...
    async fn import_reporting_task_snapshot(
        ...
        Ok(api
            .import_reporting_task_snapshot(
                &crate::v2_6_0::types::VersionedReportingTaskImportRequestEntity::try_from(body)?,
            )
            .await?
            .into())
    }
