...
pub(crate) struct V2_6_0ParameterProvidersApi<'a> {
    pub(crate) client: &'a crate::NifiClient,
}
#[allow(unused_variables)]
impl ParameterProvidersApi for V2_6_0ParameterProvidersApi<'_> {
    ...
    async fn delete_apply_parameters_request(
        ...
        let api =
            crate::v2_6_0::api::parameterproviders::ParameterProvidersApplyParametersRequestsApi {
                client: self.client,
                provider_id,
            };
        Ok(api
    ...
    async fn fetch_parameters(
        ...
        Ok(api
            .fetch_parameters(
                &crate::v2_6_0::types::ParameterProviderParameterFetchEntity::try_from(body)?,
            )
            .await?
            .into())
    }
    ...
    async fn get_property_descriptor_2(
        ...
        let api = crate::v2_6_0::api::parameterproviders::ParameterProvidersDescriptorsApi {
            client: self.client,
            id,
        };
    ...
    async fn submit_apply_parameters(
        ...
        Ok(api
            .submit_apply_parameters(
                &crate::v2_6_0::types::ParameterProviderParameterApplicationEntity::try_from(body)?,
            )
            .await?
            .into())
    }
