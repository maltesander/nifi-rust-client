...
impl ParameterContextsApi for V2_7_2ParameterContextsApi<'_> {
    ...
    async fn delete_update_request(
        ...
        let api = crate::v2_7_2::api::parametercontexts::ParameterContextsUpdateRequestsApi {
            client: self.client,
            context_id,
        };
        Ok(api
    ...
    async fn delete_validation_request(
        ...
        let api = crate::v2_7_2::api::parametercontexts::ParameterContextsValidationRequestsApi {
            client: self.client,
            context_id,
        };
        Ok(api
    ...
    async fn submit_validation_request(
        ...
        Ok(api
            .submit_validation_request(
                &crate::v2_7_2::types::ParameterContextValidationRequestEntity::try_from(body)?,
            )
            .await?
            .into())
    }
