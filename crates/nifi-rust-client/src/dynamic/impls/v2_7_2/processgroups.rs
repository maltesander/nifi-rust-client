...
pub(crate) struct V2_7_2ProcessGroupsApi<'a> {
    pub(crate) client: &'a crate::NifiClient,
}
#[allow(unused_variables)]
impl ProcessGroupsApi for V2_7_2ProcessGroupsApi<'_> {
    async fn copy(
        &self,
        id: &str,
    ...
    async fn create_controller_service_1(
        ...
        Ok(api
            .create_controller_service_1(&crate::v2_7_2::types::ControllerServiceEntity::try_from(
                body,
            )?)
            .await?
            .into())
    ...
    async fn create_remote_process_group(
        ...
        Ok(api
            .create_remote_process_group(&crate::v2_7_2::types::RemoteProcessGroupEntity::try_from(
                body,
            )?)
            .await?
            .into())
    ...
    async fn import_process_group(
        ...
        Ok(api
            .import_process_group(&crate::v2_7_2::types::ProcessGroupUploadEntity::try_from(
                body,
            )?)
            .await?
            .into())
    ...
    async fn replace_process_group(
        ...
        Ok(api
            .replace_process_group(&crate::v2_7_2::types::ProcessGroupImportEntity::try_from(
                body,
            )?)
            .await?
            .into())
