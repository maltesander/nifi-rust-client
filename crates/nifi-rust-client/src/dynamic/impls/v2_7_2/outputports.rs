...
impl OutputPortsApi for V2_7_2OutputPortsApi<'_> {
    async fn clear_bulletins_3(
        ...
        Ok(api
            .clear_bulletins_3(&crate::v2_7_2::types::ClearBulletinsRequestEntity::try_from(body)?)
            .await?
            .into())
    }
    ...
    async fn update_run_status_3(
        ...
        Ok(api
            .update_run_status_3(&crate::v2_7_2::types::PortRunStatusEntity::try_from(body)?)
            .await?
            .into())
    }
}
