...
pub(crate) struct V2_7_2InputPortsApi<'a> {
    pub(crate) client: &'a crate::NifiClient,
}
#[allow(unused_variables)]
impl InputPortsApi for V2_7_2InputPortsApi<'_> {
    async fn clear_bulletins_2(
        ...
        Ok(api
            .clear_bulletins_2(&crate::v2_7_2::types::ClearBulletinsRequestEntity::try_from(body)?)
            .await?
            .into())
    }
    ...
    async fn update_run_status_2(
        ...
        Ok(api
            .update_run_status_2(&crate::v2_7_2::types::PortRunStatusEntity::try_from(body)?)
            .await?
            .into())
    }
}
