...
impl<'a> ControllerApi<'a> {
    ...
    /// # Permissions
    /// Requires `Write - /controller`.
    pub async fn delete_node(&self, id: &str) -> Result<crate::v2_6_0::types::NodeDto, NifiError> {
        let e: crate::v2_6_0::types::NodeEntity = self
            .client
    ...
    /// # Permissions
    /// Requires `Read - /controller`.
    pub async fn get_node(&self, id: &str) -> Result<crate::v2_6_0::types::NodeDto, NifiError> {
        let e: crate::v2_6_0::types::NodeEntity = self
            .client
    ...
    pub async fn delete_history(
        ...
        let e: crate::v2_6_0::types::HistoryEntity = self
            .client
    ...
    pub async fn upload_nar(
        ...
        let e: crate::v2_6_0::types::NarSummaryEntity = self
            .client
...
impl crate::v2_6_0::traits::ControllerApi for ControllerApi<'_> {
    fn config<'b>(&'b self, id: &'b str) -> impl crate::v2_6_0::traits::ControllerConfigApi + 'b {
        ControllerConfigApi {
            client: self.client,
            id,
        }
    }
    fn content<'b>(&'b self, id: &'b str) -> impl crate::v2_6_0::traits::ControllerContentApi + 'b {
        ControllerContentApi {
            client: self.client,
            id,
        }
    ...
    fn descriptors<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::ControllerDescriptorsApi + 'b {
        ControllerDescriptorsApi {
            client: self.client,
            id,
        }
    }
    fn details<'b>(&'b self, id: &'b str) -> impl crate::v2_6_0::traits::ControllerDetailsApi + 'b {
        ControllerDetailsApi {
            client: self.client,
            id,
        }
    ...
    fn run_status<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::ControllerRunStatusApi + 'b {
        ControllerRunStatusApi {
            client: self.client,
            id,
        }
    }
    fn state<'b>(&'b self, id: &'b str) -> impl crate::v2_6_0::traits::ControllerStateApi + 'b {
        ControllerStateApi {
            client: self.client,
            id,
        }
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_6_0::traits::ControllerConfigApi for ControllerConfigApi<'_> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_6_0::traits::ControllerContentApi for ControllerContentApi<'_> {
    async fn download_nar(&self) -> Result<(), NifiError> {
        self.download_nar().await
    }
}
#[allow(clippy::too_many_arguments)]
impl crate::v2_6_0::traits::ControllerDescriptorsApi for ControllerDescriptorsApi<'_> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_6_0::traits::ControllerDetailsApi for ControllerDetailsApi<'_> {
    async fn get_nar_details(&self) -> Result<crate::v2_6_0::types::NarDetailsEntity, NifiError> {
        self.get_nar_details().await
    }
}
#[allow(clippy::too_many_arguments)]
impl crate::v2_6_0::traits::ControllerRunStatusApi for ControllerRunStatusApi<'_> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_6_0::traits::ControllerStateApi for ControllerStateApi<'_> {
