...
impl<'a> RemoteProcessGroupsStateApi<'a> {
    ...
    /// # Permissions
    /// Requires `Write - /remote-process-groups/{uuid}`.
    pub async fn get_state_3(&self) -> Result<crate::v2_6_0::types::ComponentStateDto, NifiError> {
        let id = self.id;
...
impl crate::v2_6_0::traits::RemoteProcessGroupsApi for RemoteProcessGroupsApi<'_> {
    fn input_ports<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::RemoteProcessGroupsInputPortsApi + 'b {
        RemoteProcessGroupsInputPortsApi {
            client: self.client,
            id,
        }
    ...
    fn output_ports<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::RemoteProcessGroupsOutputPortsApi + 'b {
        RemoteProcessGroupsOutputPortsApi {
            client: self.client,
            id,
        }
    ...
    fn run_status<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::RemoteProcessGroupsRunStatusApi + 'b {
        RemoteProcessGroupsRunStatusApi {
            client: self.client,
            id,
        }
    ...
    fn state<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::RemoteProcessGroupsStateApi + 'b {
        RemoteProcessGroupsStateApi {
            client: self.client,
            id,
        }
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_6_0::traits::RemoteProcessGroupsInputPortsApi
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_6_0::traits::RemoteProcessGroupsOutputPortsApi
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_6_0::traits::RemoteProcessGroupsRunStatusApi
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_6_0::traits::RemoteProcessGroupsStateApi for RemoteProcessGroupsStateApi<'_> {
