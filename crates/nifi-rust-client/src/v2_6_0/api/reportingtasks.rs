...
impl<'a> ReportingTasksRunStatusApi<'a> {
    ...
    pub async fn update_run_status_5(
        &self,
        body: &crate::v2_6_0::types::ReportingTaskRunStatusEntity,
    ) -> Result<crate::v2_6_0::types::ReportingTaskEntity, NifiError> {
        let id = self.id;
        self.client
...
impl<'a> ReportingTasksStateApi<'a> {
    ...
    pub async fn get_state_4(&self) -> Result<crate::v2_6_0::types::ComponentStateDto, NifiError> {
        let id = self.id;
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_6_0::traits::ReportingTasksConfigApi for ReportingTasksConfigApi<'_> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_6_0::traits::ReportingTasksDescriptorsApi for ReportingTasksDescriptorsApi<'_> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_6_0::traits::ReportingTasksRunStatusApi for ReportingTasksRunStatusApi<'_> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_6_0::traits::ReportingTasksStateApi for ReportingTasksStateApi<'_> {
    async fn get_state_4(&self) -> Result<crate::v2_6_0::types::ComponentStateDto, NifiError> {
