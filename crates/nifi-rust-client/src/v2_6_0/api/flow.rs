...
impl crate::v2_6_0::traits::FlowApi for FlowApi<'_> {
    fn branches<'b>(&'b self, id: &'b str) -> impl crate::v2_6_0::traits::FlowBranchesApi + 'b {
        FlowBranchesApi {
            client: self.client,
            id,
        }
    ...
    fn breadcrumbs<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::FlowBreadcrumbsApi + 'b {
        FlowBreadcrumbsApi {
            client: self.client,
            id,
        }
    }
    fn buckets<'b>(&'b self, id: &'b str) -> impl crate::v2_6_0::traits::FlowBucketsApi + 'b {
        FlowBucketsApi {
            client: self.client,
            id,
        }
    ...
    fn controller_services<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::FlowControllerServicesApi + 'b {
        FlowControllerServicesApi {
            client: self.client,
            id,
        }
    }
    fn statistics<'b>(&'b self, id: &'b str) -> impl crate::v2_6_0::traits::FlowStatisticsApi + 'b {
        FlowStatisticsApi {
            client: self.client,
            id,
        }
    }
    fn status<'b>(&'b self, id: &'b str) -> impl crate::v2_6_0::traits::FlowStatusApi + 'b {
        FlowStatusApi {
            client: self.client,
            id,
        }
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_6_0::traits::FlowBranchesApi for FlowBranchesApi<'_> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_6_0::traits::FlowBreadcrumbsApi for FlowBreadcrumbsApi<'_> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_6_0::traits::FlowBucketsApi for FlowBucketsApi<'_> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_6_0::traits::FlowControllerServicesApi for FlowControllerServicesApi<'_> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_6_0::traits::FlowStatisticsApi for FlowStatisticsApi<'_> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_6_0::traits::FlowStatusApi for FlowStatusApi<'_> {
