...
impl<'a> ParameterContextsApi<'a> {
    ...
    ) -> Result<crate::v2_6_0::types::ParameterContextEntity, NifiError> {
...
impl<'a> ParameterContextsAssetsApi<'a> {
    ...
    pub async fn create_asset(
        ...
        filename: Option<&str>,
        data: Vec<u8>,
    ) -> Result<crate::v2_6_0::types::AssetDto, NifiError> {
        let context_id = self.context_id;
        let e: crate::v2_6_0::types::AssetEntity = self
            .client
            .post_octet_stream(
...
impl<'a> ParameterContextsUpdateRequestsApi<'a> {
    ...
    pub async fn submit_parameter_context_update(
        &self,
        body: &crate::v2_6_0::types::ParameterContextEntity,
    ) -> Result<crate::v2_6_0::types::ParameterContextUpdateRequestEntity, NifiError> {
        let context_id = self.context_id;
        self.client
            .post(
...
impl<'a> ParameterContextsValidationRequestsApi<'a> {
    ...
    ) -> Result<crate::v2_6_0::types::ParameterContextValidationRequestEntity, NifiError> {
        let context_id = self.context_id;
        self.client
            .post(
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_6_0::traits::ParameterContextsAssetsApi for ParameterContextsAssetsApi<'_> {
    async fn get_assets(&self) -> Result<crate::v2_6_0::types::AssetsEntity, NifiError> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_6_0::traits::ParameterContextsUpdateRequestsApi
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_6_0::traits::ParameterContextsValidationRequestsApi
