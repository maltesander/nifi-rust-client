...
impl<'a> ParameterProvidersApplyParametersRequestsApi<'a> {
    ...
    pub async fn submit_apply_parameters(
        ...
        let e: crate::v2_6_0::types::ParameterProviderApplyParametersRequestEntity = self
            .client
            .post(
...
impl crate::v2_6_0::traits::ParameterProvidersApi for ParameterProvidersApi<'_> {
    fn apply_parameters_requests<'b>(
        &'b self,
        provider_id: &'b str,
    ) -> impl crate::v2_6_0::traits::ParameterProvidersApplyParametersRequestsApi + 'b {
        ParameterProvidersApplyParametersRequestsApi {
            client: self.client,
            provider_id,
        }
    ...
    fn config<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::ParameterProvidersConfigApi + 'b {
        ParameterProvidersConfigApi {
            client: self.client,
            id,
        }
    ...
    fn descriptors<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::ParameterProvidersDescriptorsApi + 'b {
        ParameterProvidersDescriptorsApi {
            client: self.client,
            id,
        }
    ...
    fn parameters<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::ParameterProvidersParametersApi + 'b {
        ParameterProvidersParametersApi {
            client: self.client,
            id,
        }
    ...
    fn references<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::ParameterProvidersReferencesApi + 'b {
        ParameterProvidersReferencesApi {
            client: self.client,
            id,
        }
    ...
    fn state<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::ParameterProvidersStateApi + 'b {
        ParameterProvidersStateApi {
            client: self.client,
            id,
        }
