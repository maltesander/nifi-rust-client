...
impl<'a> ProcessGroupsConnectionsApi<'a> {
    ...
    pub async fn get_connections(
        &self,
    ) -> Result<crate::v2_6_0::types::ConnectionsEntity, NifiError> {
        let id = self.id;
        self.client
...
impl<'a> ProcessGroupsEmptyAllConnectionsRequestsApi<'a> {
    ...
    pub async fn create_empty_all_connections_request(
        ...
        let id = self.id;
        let e: crate::v2_6_0::types::DropRequestEntity = self
            .client
            .post_no_body(&format!(
...
impl<'a> ProcessGroupsFunnelsApi<'a> {
    ...
    /// # Permissions
    /// Requires `Read - /process-groups/{uuid}`.
    pub async fn get_funnels(&self) -> Result<crate::v2_6_0::types::FunnelsEntity, NifiError> {
        let id = self.id;
        self.client
...
impl<'a> ProcessGroupsInputPortsApi<'a> {
    ...
    pub async fn get_input_ports(
        &self,
    ) -> Result<crate::v2_6_0::types::InputPortsEntity, NifiError> {
        let id = self.id;
        self.client
...
impl<'a> ProcessGroupsLabelsApi<'a> {
    ...
    /// # Permissions
    /// Requires `Read - /process-groups/{uuid}`.
    pub async fn get_labels(&self) -> Result<crate::v2_6_0::types::LabelsEntity, NifiError> {
        let id = self.id;
        self.client
...
impl<'a> ProcessGroupsOutputPortsApi<'a> {
    ...
    pub async fn get_output_ports(
        &self,
    ) -> Result<crate::v2_6_0::types::OutputPortsEntity, NifiError> {
        let id = self.id;
        self.client
...
impl<'a> ProcessGroupsSnippetInstanceApi<'a> {
    ...
    pub async fn copy_snippet(
        ...
        let id = self.id;
        let e: crate::v2_6_0::types::FlowEntity = self
            .client
...
impl crate::v2_6_0::traits::ProcessGroupsApi for ProcessGroupsApi<'_> {
    fn connections<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::ProcessGroupsConnectionsApi + 'b {
        ProcessGroupsConnectionsApi {
            client: self.client,
            id,
        }
    ...
    fn controller_services<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::ProcessGroupsControllerServicesApi + 'b {
        ProcessGroupsControllerServicesApi {
            client: self.client,
            id,
        }
    }
    fn copy<'b>(&'b self, id: &'b str) -> impl crate::v2_6_0::traits::ProcessGroupsCopyApi + 'b {
        ProcessGroupsCopyApi {
            client: self.client,
            id,
        }
    ...
    fn download<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::ProcessGroupsDownloadApi + 'b {
        ProcessGroupsDownloadApi {
            client: self.client,
            id,
        }
    ...
    fn empty_all_connections_requests<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::ProcessGroupsEmptyAllConnectionsRequestsApi + 'b {
        ProcessGroupsEmptyAllConnectionsRequestsApi {
            client: self.client,
            id,
        }
    ...
    fn flow_contents<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::ProcessGroupsFlowContentsApi + 'b {
        ProcessGroupsFlowContentsApi {
            client: self.client,
            id,
        }
    ...
    fn funnels<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::ProcessGroupsFunnelsApi + 'b {
        ProcessGroupsFunnelsApi {
            client: self.client,
            id,
        }
    ...
    fn input_ports<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::ProcessGroupsInputPortsApi + 'b {
        ProcessGroupsInputPortsApi {
            client: self.client,
            id,
        }
    ...
    fn labels<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::ProcessGroupsLabelsApi + 'b {
        ProcessGroupsLabelsApi {
            client: self.client,
            id,
        }
    ...
    fn local_modifications<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::ProcessGroupsLocalModificationsApi + 'b {
        ProcessGroupsLocalModificationsApi {
            client: self.client,
            id,
        }
    ...
    fn output_ports<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::ProcessGroupsOutputPortsApi + 'b {
        ProcessGroupsOutputPortsApi {
            client: self.client,
            id,
        }
    }
    fn paste<'b>(&'b self, id: &'b str) -> impl crate::v2_6_0::traits::ProcessGroupsPasteApi + 'b {
        ProcessGroupsPasteApi {
            client: self.client,
            id,
        }
    ...
    fn process_groups<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::ProcessGroupsProcessGroupsApi + 'b {
        ProcessGroupsProcessGroupsApi {
            client: self.client,
            id,
        }
    ...
    fn processors<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::ProcessGroupsProcessorsApi + 'b {
        ProcessGroupsProcessorsApi {
            client: self.client,
            id,
        }
    ...
    fn remote_process_groups<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::ProcessGroupsRemoteProcessGroupsApi + 'b {
        ProcessGroupsRemoteProcessGroupsApi {
            client: self.client,
            id,
        }
    ...
    fn replace_requests<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::ProcessGroupsReplaceRequestsApi + 'b {
        ProcessGroupsReplaceRequestsApi {
            client: self.client,
            id,
        }
    ...
    fn snippet_instance<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::ProcessGroupsSnippetInstanceApi + 'b {
        ProcessGroupsSnippetInstanceApi {
            client: self.client,
            id,
        }
