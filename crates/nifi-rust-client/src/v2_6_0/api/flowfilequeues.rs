...
impl<'a> FlowFileQueuesFlowfilesApi<'a> {
    ...
    ) -> Result<crate::v2_6_0::types::FlowFileDto, NifiError> {
        let id = self.id;
        let mut query: Vec<(&str, String)> = vec![];
        if let Some(v) = cluster_node_id {
            query.push(("clusterNodeId", v.to_string()));
        }
        let e: crate::v2_6_0::types::FlowFileEntity = self
            .client
            .get_with_query(
...
impl<'a> FlowFileQueuesListingRequestsApi<'a> {
    ...
    pub async fn create_flow_file_listing(
        &self,
    ) -> Result<crate::v2_6_0::types::ListingRequestDto, NifiError> {
        let id = self.id;
        let e: crate::v2_6_0::types::ListingRequestEntity = self
            .client
...
impl crate::v2_6_0::traits::FlowFileQueuesApi for FlowFileQueuesApi<'_> {
    fn drop_requests<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::FlowFileQueuesDropRequestsApi + 'b {
        FlowFileQueuesDropRequestsApi {
            client: self.client,
            id,
        }
    ...
    fn flowfiles<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::FlowFileQueuesFlowfilesApi + 'b {
        FlowFileQueuesFlowfilesApi {
            client: self.client,
            id,
        }
    ...
    fn listing_requests<'b>(
        &'b self,
        id: &'b str,
    ) -> impl crate::v2_6_0::traits::FlowFileQueuesListingRequestsApi + 'b {
        FlowFileQueuesListingRequestsApi {
            client: self.client,
            id,
        }
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_6_0::traits::FlowFileQueuesDropRequestsApi for FlowFileQueuesDropRequestsApi<'_> {
    async fn create_drop_request(&self) -> Result<crate::v2_6_0::types::DropRequestDto, NifiError> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_6_0::traits::FlowFileQueuesFlowfilesApi for FlowFileQueuesFlowfilesApi<'_> {
...
#[allow(clippy::too_many_arguments)]
impl crate::v2_6_0::traits::FlowFileQueuesListingRequestsApi
